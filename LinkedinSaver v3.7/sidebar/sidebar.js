...
document.addEventListener('DOMContentLoaded', async function() {
  ...
  // Modal Close Handlers - 1:1 aus dem Feedback
  const postModalClose = document.querySelector('#post-modal .modal-close');
  const categoryModalClose = document.querySelector('#category-modal .modal-close');
  const folderModalClose = document.querySelector('#folder-modal .modal-close');
  const bulkCategoriesModalClose = document.querySelector('#bulk-categories-modal .modal-close');
  const bulkFolderModalClose = document.querySelector('#bulk-folder-modal .modal-close');
  const summaryModalClose = document.querySelector('#summary-modal .modal-close');

  // Event-Listener für alle Modal-Close-Buttons
  if (postModalClose) postModalClose.addEventListener('click', () => { if (postModal) postModal.style.display = 'none'; });
  if (categoryModalClose) categoryModalClose.addEventListener('click', () => { if (categoryModal) categoryModal.style.display = 'none'; });
  if (folderModalClose) folderModalClose.addEventListener('click', () => { if (folderModal) folderModal.style.display = 'none'; });
  if (bulkCategoriesModalClose) bulkCategoriesModalClose.addEventListener('click', () => { if (bulkCategoriesModal) bulkCategoriesModal.style.display = 'none'; });
  if (bulkFolderModalClose) bulkFolderModalClose.addEventListener('click', () => { if (bulkFolderModal) bulkFolderModal.style.display = 'none'; });
  ...
  window.addEventListener('click', (e) => {
    if (e.target === postModal && postModal) postModal.style.display = 'none';
    if (e.target === categoryModal && categoryModal) categoryModal.style.display = 'none';
