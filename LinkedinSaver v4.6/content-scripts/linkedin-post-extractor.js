...
function extractDataFromPostElement(postElement) {
  ...
  try {
    ...
    const permalinkSelectors = [
      ...
      'a.feed-shared-control-menu__control-item[href*="/posts/"]',
      'a.update-components-control-menu__control-item[href*="/posts/"]',
      'a.feed-shared-control-menu__control-item[href*="/feed/update/"]',
      'a.update-components-control-menu__control-item[href*="/feed/update/"]'
    ];
